...
- **Target:** 225 animals
- **Completed research files:** 122 / 225
- **Verified full-body transparent PNGs committed:** 0 / 122
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Lynx / Eurasian Lynx (*Lynx lynx*)
- **Next pending animal:** Macaw
- **Latest completion:** 2026-09-21 07:01 America/Chicago
- **Latest new-animal image status:** Lynx - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. Exact male *L. lynx*, 5184x3456 CC BY-SA 4.0 Commons source; adulthood is not explicit and the resting-tree pose does not certify every foot/appendage. No PNG completion claimed.
- **Latest legacy image audit:** Kangaroo - exact adult/sexually mature male ADW source is visually full-body but only about 600px wide; existing 3648x2736 candidate lacks explicit adulthood and strict complete-foot/tail verification. Status `REPLACEMENT SOURCE NEEDED`.
- **Next legacy image audit:** King Cobra. Hellbender, Hornet, Ibex and Kudu are source-verified and remain cutout/commit pending while the writer is text-only.
...
- **Lynx control:** Eurasian lynx *Lynx lynx*, healthy fully mature male, 24.0 kg / 54.0 cm shoulder / 103.0 cm head-body. `speed_mps` 0.0; `lifespan_years` 17.0; `bite_force_psi` 0.0. Attack 48.0 / Defense 31.0 / Agility 85.0 / Stamina 68.0 / Intelligence 67.0 / Special 66.0. Roe-deer predation supports efficient weapon delivery but must not leak into leopard-scale absolute power.
- **Lobster control:** American lobster *Homarus americanus*, healthy fully mature hard-shelled male, 1.0 kg / 30.0 cm total length. Attack 28.0 / Defense 36.0 / Agility 35.0 / Stamina 57.0 / Intelligence 48.0 / Special 60.0.
- **Llama control:** domestic *Lama glama*, healthy fully mature intact male, 150.0 kg / 121.0 cm shoulder / 160.0 cm head-body. Attack 40.0 / Defense 36.0 / Agility 60.0 / Stamina 77.0 / Intelligence 60.0 / Special 54.0.
- **Lionfish control:** red lionfish *Pterois volitans*, mature male, 0.5 kg / 38.0 cm. Attack 25.0 / Defense 38.0 / Agility 52.0 / Stamina 55.0 / Intelligence 58.0 / Special 87.0.
