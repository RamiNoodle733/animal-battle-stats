...
- **Target:** 225 animals
- **Completed research files:** 116 / 225
- **Verified full-body transparent PNGs committed:** 0 / 116
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Kudu, resolved to Greater Kudu (*Tragelaphus strepsiceros*)
- **Next pending animal:** Leatherback Sea Turtle
- **Latest completion:** 2026-09-21 01:00 America/Chicago
- **Latest new-animal image status:** Kudu - `FULL-BODY SOURCE FOUND - CUTOUT/COMMIT PENDING`. Exact-species 3008x2000 CC BY-SA 2.0 Commons source explicitly identifies an adult male; direct inspection verifies head, torso, four legs/hooves, tail and horns inside frame. No PNG completion claimed.
- **Latest legacy image audit:** Ibex - upgraded to `FULL-BODY SOURCE FOUND - CUTOUT/COMMIT PENDING`. Exact adult male *Capra ibex* 3233x2155 CC BY-SA 4.0 source was visually inspected and complete anatomy is in frame. Source page/direct URL were already present in the Ibex report. Binary cutout remains pending.
- **Next legacy image audit:** Iguana. Hellbender, Hornet and Ibex are source-verified and remain cutout/commit pending while the writer is text-only.
...
- **Kudu control:** Greater Kudu *Tragelaphus strepsiceros*, healthy fully mature male 230.0 kg / 145.0 cm shoulder / 220.0 cm head-body. `speed_mps` 0.0; `lifespan_years` 10.0; `bite_force_psi` 0.0. Attack 58.0 / Defense 43.0 / Agility 72.0 / Stamina 60.0 / Intelligence 49.0 / Special 61.0. Long spiral horns raise reach/leverage and Attack, while disputed 60–97 km/h web/institutional speed claims are not canonized.
...
116 research reports are complete, but **0 verified transparent PNG binaries are committed**. Several animals now have reusable full-body source candidates, including Hellbender, Hornet, Ibex and Kudu, but current connected GitHub `create_file` / `update_file` actions accept UTF-8 text only. No JPEG rename, base64-text pseudo-PNG, opaque checkerboard or other fake image is created. `IMAGE_BACKFILL.md` remains the legacy audit queue.
