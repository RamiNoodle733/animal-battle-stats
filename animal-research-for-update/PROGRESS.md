...
- **Target:** 225 animals
- **Completed research files:** 190 / 225
- **Verified full-body transparent PNGs committed:** 0 / 190
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Serval (*Leptailurus serval*)
- **Next pending animal:** Shoebill
- **Latest completion:** 2026-09-24 03:02 America/Chicago
- **Latest new-animal image status:** Serval - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. A 5184×3456 CC BY 2.0 exact-species South Luangwa candidate has excellent reusable provenance, but source metadata does not explicitly establish adulthood/sex and strict complete-body framing was not certified. A 1600×1121 wild Serengeti side-view candidate was directly rejected because the rear/tail is clipped. No PNG is claimed.
- **Latest legacy image audit:** Opossum (*Didelphis virginiana*). A 2048×1365 CC BY 4.0 walking candidate remains reusable but visibly fails strict tail/rear framing and lacks explicit adulthood. An American Society of Mammalogists/Mammal Diversity Database record explicitly identifies a side-view adult, but redistribution permission was not established in this run. Status remains `SOURCE FOUND - FULL-BODY NOT VERIFIED` / adult-provenance lead only.
- **Next legacy image audit:** Orangutan. Source-verified animals awaiting binary cutout/commit tooling remain separate from unresolved source-quality cases.
...
190 research reports are complete, but **0 verified transparent PNG binaries are committed**. Current connected GitHub `create_file` / `update_file` actions accept UTF-8 text only. No JPEG rename, base64-text pseudo-PNG, opaque checkerboard or other fake image is created. `IMAGE_BACKFILL.md` remains the legacy audit queue.