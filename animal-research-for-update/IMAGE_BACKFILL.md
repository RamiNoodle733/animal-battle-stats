...
**Research reports completed:** 34 / 225 (through Bottlenose Dolphin). **Full-body transparent PNG assets verified and committed in this staging image directory:** 0 / 34. A source-photo link is not an approved PNG.
...
| Alpaca | **Verified source:** 2798×1998 *Vicugna pacos*, `Corazon Full.jpg`, Notnoisy, CC BY 3.0; Commons uploader explicitly describes the animal as shown in full body and image was selected specifically as a full-body example | No | Binary cutout/commit pending; sex is unverified, so an equally strong verified adult-male source may supersede it later |
| Anaconda | Unverified | No | Audit entire head-to-tail snake next |
...
| Bottlenose Dolphin | **SOURCE FOUND - FULL-BODY NOT VERIFIED:** exact *Tursiops truncatus*, Gregory Smith, 3053×2212, CC BY-SA 2.0 | No | Strictly verify complete rostrum, flippers, dorsal fin and tail/flukes on one unobscured adult; sex unknown |

## Image count and acceptance rule

- `34` is a text-research count, not the number of valid images.
...
- **2026-09-17 Alpaca:** Replaced the unresolved Peter O'Connor candidate with Wikimedia Commons `Corazon Full.jpg`, exact *Vicugna pacos*, 2798×1998, photographed by Notnoisy and licensed CC BY 3.0. Commons explicitly describes Corazon as shown `in full body` and the upload comment calls it a full-body example. Source page: https://commons.wikimedia.org/wiki/File:Corazon_Full.jpg . Original file is linked by Commons at 2798×1998. Sex is not established, so a verified adult-male equivalent remains preferable if found later, but the whole-body source requirement is now satisfied for backfill purposes. Cutout/PNG commit remains pending.
...
- **2026-09-17 Bongo:** Joe Schneid Commons Quality Image is 2848×4288, exact *Tragelaphus eurycerus*, explicitly male and CC BY-SA 3.0. Strict all-hoof/full-tail framing is not yet verified.
- **2026-09-17 Bottlenose Dolphin:** exact-species 3053×2212 Gregory Smith Commons source is CC BY-SA 2.0 but remains strict whole-body/adult unverified. A separate 2643×1762 Bramans Commons photo was directly inspected and rejected because water hides most of the body.
...
- **Next legacy audit:** Anaconda is now the oldest unresolved image.
