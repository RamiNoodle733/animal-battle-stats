...
- **Target:** 225 animals
- **Completed research files:** 176 / 225
- **Verified full-body transparent PNGs committed:** 0 / 176
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Red-tailed Hawk - *Buteo jamaicensis*
- **Next pending animal:** Reindeer
- **Latest completion:** 2026-09-23 13:01 America/Chicago
- **Latest new-animal image status:** Red-tailed Hawk - `REPLACEMENT SOURCE NEEDED`. A 3314x2836 CC BY 3.0 Commons photograph explicitly identifies an exact-species three-year-old female, but direct inspection shows a portrait with the lower body, feet and tail outside the frame. It is retained only as provenance evidence and must not be promoted. No PNG is claimed.
- **Latest legacy image audit:** King Crab / *Paralithodes camtschaticus*. Fresh broad searching found a 5184x3888 CC BY-SA 4.0 exact-species Commons series and an explicit large-male NOAA/Flickr source. The new Commons image was directly inspected and clips/obscures major appendages; the NOAA source remains the strongest explicit-male provenance but does not satisfy strict full-appendage framing. Status remains `SOURCE FOUND - FULL-BODY NOT VERIFIED`.
- **Next legacy image audit:** Kiwi. Megalodon remains a structural extinct-photo blocker. Hellbender, Hornet, Ibex, Kudu, Lionfish, Gecko, Giraffe, Guanaco, Hercules Beetle, Pronghorn and Pufferfish are source-verified and awaiting binary cutout/commit tooling.
...
- Maximum speed remains 0.0 where no defensible species-specific maximum exists. Strike/dive speed is not automatically travel speed, and speed is not Agility.
...
- **Red-tailed Hawk control:** *Buteo jamaicensis*, healthy prime adult female, 1.2 kg / 58.0 cm total length / ~125 cm wingspan context / 0.0 m/s unresolved maximum / 20.0 y conservative longevity context / 0.0 PSI unsupported. Attack 35.0 / Defense 23.0 / Agility 90.0 / Stamina 74.0 / Intelligence 65.0 / Special 74.0. Talons and aerial delivery raise Weaponry/Attack; broad-wing control raises Agility; flight is not reused as physical armor. USGS maximum longevity of 30 y 8 mo is recorded as a record, not typical lifespan.
...
176 research reports are complete, but **0 verified transparent PNG binaries are committed**. Current connected GitHub `create_file` / `update_file` actions accept UTF-8 text only. No JPEG rename, base64-text pseudo-PNG, opaque checkerboard or other fake image is created. `IMAGE_BACKFILL.md` remains the legacy audit queue.