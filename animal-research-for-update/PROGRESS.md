...
- **Target:** 225 animals
- **Completed research files:** 191 / 225
- **Verified full-body transparent PNGs committed:** 0 / 191
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Shoebill (*Balaeniceps rex*)
- **Next pending animal:** Siberian Tiger
- **Latest completion:** 2026-09-24 04:00 America/Chicago
- **Latest new-animal image status:** Shoebill - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. A 1438×2126 CC BY 3.0 exact-species Michael Gäbler photograph was directly inspected and cleanly shows the whole visible bird, including head/bill, torso, both legs/feet and tail/feather silhouette. Source metadata does not explicitly establish adulthood or sex, so it is not promoted. No PNG is claimed.
- **Latest legacy image audit:** Orangutan (*Pongo pygmaeus*). A 5184×3456 CC BY-SA 4.0 Commons source explicitly identifies the individual as male, but the current image fetch could not render the oversized original for strict appendage inspection and metadata does not explicitly establish adulthood/flanged maturity. Status remains `SOURCE FOUND - FULL-BODY NOT VERIFIED`.
- **Next legacy image audit:** Orca. Source-verified animals awaiting binary cutout/commit tooling remain separate from unresolved source-quality cases.
...
- **Shoebill control:** *Balaeniceps rex*, healthy prime adult male, 5.4 kg / 130.0 cm standing height / unresolved standardized top speed / 35.0 y / 0.0 PSI unresolved. Bill about 30.5 cm long × 12.7 cm wide. Attack 34.0 / Defense 21.0 / Agility 62.0 / Stamina 56.0 / Intelligence 55.0 / Special 67.0. Bangweulu field study found 85% low-energy activity, one prey per 8.3 h and 71% catfish among observed prey.
...
191 research reports are complete, but **0 verified transparent PNG binaries are committed**. Current connected GitHub `create_file` / `update_file` actions accept UTF-8 text only. No JPEG rename, base64-text pseudo-PNG, opaque checkerboard or other fake image is created. `IMAGE_BACKFILL.md` remains the legacy audit queue.