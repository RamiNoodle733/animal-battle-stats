...
**Research reports completed:** 75 / 225 (through Gecko). **Full-body transparent PNG assets verified and committed:** 0 / 75. A source-photo URL is not an approved PNG.
...
|---|---|---|---|
| African Elephant | VERIFIED: 6000x4000 adult male *Loxodonta africana*, CC BY-SA 4.0 | No | Binary pending |
...
| Alpaca | VERIFIED: 2798x1998 *Vicugna pacos*, CC BY 3.0 | No | Binary pending |
| Anaconda | SOURCE FOUND - FULL-BODY NOT VERIFIED | No | Clearer adult source |
...
| Armadillo | REPLACEMENT SOURCE NEEDED | No | Adult *Dasypus mexicanus* |
| Army Ant | REPLACEMENT SOURCE NEEDED | No | Better *Eciton burchellii* major |
| Axolotl | REPLACEMENT SOURCE NEEDED | No | Adult complete anatomy |
...
| Badger | REPLACEMENT SOURCE NEEDED | No | Adult *Meles meles* |
| Bald Eagle | REPLACEMENT SOURCE NEEDED | No | 1600+ adult complete view |
| Barn Owl | SOURCE FOUND - FULL-BODY NOT VERIFIED | No | Wings/talons/tail/adult |
...
| Bighorn Sheep | SOURCE FOUND - FULL-BODY NOT VERIFIED: male 4500x3000 | No | Adult + anatomy |
| Bison | SOURCE FOUND - FULL-BODY NOT VERIFIED: bull 2816x2120 | No | Hooves/tail |
...
| Black Panther | REPLACEMENT SOURCE NEEDED | No | Adult male melanistic leopard |
| Black Rhinoceros | VERIFIED: 3456x2168 adult male | No | Binary pending |
| Black Widow | SOURCE FOUND - FULL-BODY NOT VERIFIED: female 1670x1144 | No | All-eight-leg certification |
| Blue Whale | SOURCE FOUND - FULL-BODY NOT VERIFIED: adult 1792x1128 NOAA | No | Complete fins/flukes |
| Boa Constrictor | SOURCE FOUND - FULL-BODY NOT VERIFIED: 4928x3264 | No | Adult + head-to-tail |
| Bobcat | VERIFIED: 1600x1160 wild adult male | No | Binary pending |
| Bongo | SOURCE FOUND - FULL-BODY NOT VERIFIED: male 2848x4288 | No | Adult + full body |
| Bottlenose Dolphin | REPLACEMENT SOURCE NEEDED | No | Adult underwater silhouette |
| Box Jellyfish | REPLACEMENT SOURCE NEEDED | No | Mature *Chironex fleckeri* |
| Bull Shark | SOURCE FOUND - FULL-BODY NOT VERIFIED: 4000x3000 | No | Adult + complete fins/caudal |
...
| Camel Spider | SOURCE FOUND - FULL-BODY NOT VERIFIED: *Galeodes arabs* 1536x2048 | No | Skip until stronger evidence/tooling |
...
| Chimpanzee | SOURCE FOUND - FULL-BODY NOT VERIFIED: male 3798x2848 | No | Explicit-adult replacement not certified; skip |
...
| Cockatoo | SOURCE FOUND - FULL-BODY NOT VERIFIED: explicit adult *Cacatua galerita* 5472x3648 CC BY-SA 4.0 | No | Adult verified; strict anatomy unresolved; skip |
...
| Cougar | SOURCE FOUND - FULL-BODY NOT VERIFIED: P-1 adult male 1752x1177 NPS public domain | No | Adult/male verified; strict framing unresolved; skip |
| Coyote | SOURCE FOUND - FULL-BODY NOT VERIFIED: male/“Alpha Male” 2971x2377 CC BY 2.0 | No | Audit repeated once; strict adult+paws+tail certification still unresolved; skip |
| Crow | SOURCE FOUND - FULL-BODY NOT VERIFIED: 5568x3712 | No | **NEXT LEGACY AUDIT: adult/toes/tail** |
...
| Fennec Fox | SOURCE FOUND - FULL-BODY NOT VERIFIED: 3197x2477 CC BY 2.0 | No | Second fox present; adult/sex unresolved |
| Ferret | SOURCE FOUND - FULL-BODY NOT VERIFIED | No | Continue search |
| Flamingo | SOURCE FOUND - FULL-BODY NOT VERIFIED: *Phoenicopterus roseus* 6000x4000 CC BY-SA 4.0 | No | Adult + strict feet/body-edge verification |
...
### 2026-09-19 Coyote legacy audit
Existing candidate page: https://commons.wikimedia.org/wiki/File:Alpha_Male_Coyote_by_Don_Green_(49736243467).jpg

Direct original recorded in `animals/coyote.md`: https://upload.wikimedia.org/wikipedia/commons/6/62/Alpha_Male_Coyote_by_Don_Green_%2849736243467%29.jpg

Commons categorizes the 2971x2377 source under male *Canis latrans* and the file title identifies an “Alpha Male Coyote.” Broader Commons review found many additional male sources, including 6000x4000 material. However, this run still did not establish the combination required by the strict standard: explicit healthy adulthood plus visually certified complete tail and every paw in a reusable source. The existing candidate therefore remains **SOURCE FOUND - FULL-BODY NOT VERIFIED**. It should now be skipped rather than repeatedly revisited unless stronger evidence or binary tooling appears.

Next unresolved legacy audit: **Crow**.

### 2026-09-19 Gecko new-animal image
Candidate page: https://commons.wikimedia.org/wiki/File:Tokay_gecko_(Gekko_gecko)_adult_male.jpg

The source is exact *Gekko gecko*, explicitly **adult male**, museum specimen USNM 573671, and CC BY 3.0 from a ZooKeys publication. It is only **1008x460** and was cropped from a larger scientific figure. This is excellent identity/adult/sex provenance but fails the preferred 1600+ quality target and was not accepted as the mandatory clean full-body source. Broader image search found visually complete commercial stock photos, but redistribution is not justified from those results. Status: **REPLACEMENT SOURCE NEEDED**.
...
## Count and blocker
- `75` is completed text research, not completed images.
