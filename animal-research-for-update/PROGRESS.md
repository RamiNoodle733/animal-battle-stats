...
- **Target:** 225 animals
- **Completed research files:** 109 / 225
- **Verified full-body transparent PNGs committed:** 0 / 109
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Kangaroo / Red Kangaroo (*Osphranter rufus*)
- **Next pending animal:** King Cobra
- **Latest completion:** 2026-09-20 18:00 America/Chicago
- **Latest new-animal image status:** Kangaroo - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. Preferred reusable source is a 3648x2736 CC BY 2.0 exact-red-kangaroo photograph with independently reviewed Flickr provenance. Direct visual inspection shows a single animal with head, torso, limbs and tail in frame, but grass/pose prevents strict every-foot/tail-end certification and adulthood is not explicit. No PNG completion claimed.
- **Latest legacy image audit:** Hercules Beetle - a materially stronger 4000x2248 CC BY 2.0 exact-*Dynastes hercules* living imago photograph was found. Source text states it had just emerged as a beetle after two years, establishing adult/imago stage, and the license was independently reviewed by Commons. However, strict visibility of all six feet/appendage tips could not be certified from the accessible original in this run, so status remains `SOURCE FOUND - FULL-BODY NOT VERIFIED` rather than complete.
- **Next legacy image audit:** Hippopotamus. Hellbender and Hornet are already source-verified and remain cutout/commit pending while the writer is text-only.
...
- **Kangaroo control:** red kangaroo *Osphranter rufus*, healthy fully mature male 80.0 kg / 150.0 cm posture-sensitive upright height / 250.0 cm derived total length. `speed_mps` 17.8 from Taronga's 64 km/h institutional value; `lifespan_years` 20.0 wild-longevity control; `bite_force_psi` 0.0. Attack 52.0 / Defense 38.0 / Agility 80.0 / Stamina 86.0 / Intelligence 51.0 / Special 68.0. Elastic hopping economy supports Stamina but is not allowed to inflate Attack or Defense.
- **Japanese Macaque control:** *Macaca fuscata*, healthy fully mature male 11.3 kg / 57.0 cm head-body / 66.3 cm derived total length. `height_cm` 0.0; `speed_mps` 0.0; `lifespan_years` 28.0; `bite_force_psi` 0.0. Attack 31.0 / Defense 28.0 / Agility 79.0 / Stamina 67.0 / Intelligence 84.0 / Special 72.0.
- **Jaguar control:** *Panthera onca*, healthy mature Pantanal male 100.0 kg / 75.0 cm shoulder / 250.0 cm derived total length. Attack 68.0 / Defense 48.0 / Agility 82.0 / Stamina 64.0 / Intelligence 70.0 / Special 75.0.
