...
Current release (2.16.0): close the baseline and security/integrity milestones with an executable reconciliation of all 95 historical backend findings, typed signup/email validation, shared leaderboard XP semantics, safe legacy moderation and bounded rename history. No destructive data migration is required.
