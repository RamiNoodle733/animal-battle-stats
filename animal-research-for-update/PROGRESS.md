...
- **Target:** 225 animals
- **Completed research files:** 147 / 225
- **Verified full-body transparent PNGs committed:** 0 / 147
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Orangutan, resolved to Bornean Orangutan (*Pongo pygmaeus*)
- **Next pending animal:** Orca
- **Latest completion:** 2026-09-22 08:00 America/Chicago
- **Latest new-animal image status:** Orangutan - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. A 5568x3712 CC BY-SA 2.0 exact-*P. pygmaeus* source explicitly documents a mature male with developed cheek pads and has strong reusable provenance, but strict visibility of every hand/foot and the complete silhouette is not established.
- **Latest legacy image audit:** Gibbon - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. The report resolves Gibbon to *Hylobates lar*. A 2048x1536 CC BY-SA 2.0 wild male source from Khao Yai is exact-species and sex-verified, but direct visual inspection shows foliage/branches obscuring substantial anatomy. A commercial adult full-body image was not redistributed because an open reuse right was not established.
- **Next legacy image audit:** Gila Monster. Megalodon remains a structural blocker because the mandatory real-adult-photograph requirement cannot be satisfied for an extinct species. Hellbender, Hornet, Ibex, Kudu, Lionfish and Gecko are source-verified and awaiting binary cutout/commit tooling.
...
- **Gibbon comparison control:** White-handed Gibbon *Hylobates lar*, mature male 6.5 kg. Its elite canopy maneuverability must not be confused with orangutan raw power.
