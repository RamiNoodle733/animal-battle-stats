...
- **Target:** 225 animals
- **Completed research files:** 107 / 225
- **Verified full-body transparent PNGs committed:** 0 / 107
- **Research source list:** `../DATA_PROGRESS.md`
- **Output directory:** `animals/`
- **Status:** In progress
- **Most recently completed:** Jaguar (*Panthera onca*)
- **Next pending animal:** Japanese Macaque
- **Latest completion:** 2026-09-20 15:59 America/Chicago
- **Latest new-animal image status:** Jaguar - `SOURCE FOUND - FULL-BODY NOT VERIFIED`. Preferred reusable exact Pantanal male source is 4582x3054 CC BY-SA 4.0; sex and provenance are explicit, but adulthood and strict original-binary complete-body certification remain unresolved. No PNG completion claimed.
- **Latest legacy image audit:** Harpy Eagle - stronger 5184x3456 exact-species CC BY 2.0 Commons/Flickr source found with independently reviewed license provenance. Adulthood/sex are not explicit and strict feet/tail/wing completeness is not certified, so status remains `SOURCE FOUND - FULL-BODY NOT VERIFIED`.
- **Next legacy image audit:** Hedgehog, skipping already-audited entries unless binary tooling or materially better evidence appears.
...
- **Jaguar control:** *Panthera onca*, healthy mature Pantanal male 100.0 kg / 75.0 cm shoulder / 250.0 cm derived total length. `speed_mps` 0.0 because no transparent instrumented species maximum was recovered; `lifespan_years` 12.0 wild control; `bite_force_psi` 0.0 because published biomechanical force estimates are not pressure. Attack 68.0 / Defense 48.0 / Agility 82.0 / Stamina 64.0 / Intelligence 70.0 / Special 75.0. Durophagous bite specialization is recognized without converting proportional bite reputation into roster-wide raw-power inflation.
- **Jackal control:** black-backed jackal *Lupulella mesomelas*, mature male 8.1 kg / 40.0 cm shoulder / 111.1 cm derived total length. `speed_mps` 0.0 because strong species-specific maximum-speed evidence was not recovered; `lifespan_years` 8.0 wild control; `bite_force_psi` 0.0. Attack 34.0 / Defense 27.0 / Agility 74.0 / Stamina 66.0 / Intelligence 68.0 / Special 53.0.
- **Impala control:** *Aepyceros melampus*, healthy fully mature territorial male 65.0 kg / 90.0 cm shoulder / 145.0 cm head-body. `speed_mps` 22.2 from an institutional 80 km/h value with moderate confidence; `lifespan_years` 15.0; `bite_force_psi` 0.0. Attack 43.0 / Defense 31.0 / Agility 91.0 / Stamina 64.0 / Intelligence 48.0 / Special 62.0.
...
107 research reports are complete, but **0 verified transparent PNG binaries are committed**. Several animals have reusable full-body source candidates, but current connected GitHub `create_file` / `update_file` actions accept UTF-8 text only. No JPEG rename, base64-text pseudo-PNG, opaque checkerboard or other fake image is created. `IMAGE_BACKFILL.md` remains the legacy audit queue.
