...
function getPublicUrls() {
    const fixedPaths = ['/', '/about', '/battle', '/methodology', '/stats', '/compare', '/rankings', '/community', '/tournament'];
...
function getLastmod(pathname) {
    if (pathname === '/battle' || pathname === '/methodology') return '2026-09-13';
...
function buildPageMeta(pathname) {
    ...
    const baseDescription = 'Choose two animals, run a transparent matchup estimate, inspect the deciding ratings, and explore 225 animal profiles, rankings, and tournaments.';
